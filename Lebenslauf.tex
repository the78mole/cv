...
\cventry{05/18--jetzt}{Teamleiter \& Embeddedentwickler}{Angestellter}{Fürth}{Dommel GmbH}%
{\begin{itemize}
	...
	\item Anwendungsentwicklung von PC-Applikationen (Firmware-Updater, Service-Tools; \textbf{JavaSE}, QT)
...
{\begin{itemize}
	...
	\item In-House Prozessautomatisierung mit Camunda (\textbf{JavaEE})
...
{\begin{itemize}
	\item Teilprojektleitung \& Softwarearchitektur, \glqq digitale Straßenkarte\grqq (C++, Embedded Linux, ASIL-B)
	...
	\item Aufbau eines Cert-Service für Device-Zertifikate (\textbf{JavaEE}, Bouncycastle, REST, WebUI)
	\item Erweiterung des Backends eines KfZ-Ferndiagnosesystems (\textbf{JavaEE})
	\item Refactoring des bestehenden Backends eines KfZ-Ferndiagnosesystems (\textbf{JavaEE})
\end{itemize}}
...
{\begin{itemize}
	...
	\begin{itemize}
		...
		\item Impementierung der OSGi-Services für KWK-Optimierung (\textbf{Java}, OSGi/Equinox)
		\item Erfassung von KWK-Kraftwerksdaten (Embedded uC Knoten , Ethernet, PoE)
		\item Prognose der Folgetage auf Basis von Wetterdaten und KNN (\textbf{Java}, Encog)
		\item Integration des Simulationskerns aus studentischer Arbeit (\textbf{Java}, OSGi/Equinox)
		\item VPN zur Fernwartung und Verbindung mit Backend (OpenVPN)
		\item Aufbau der zentralen Server-Infrastruktur (ETL z.B. GRIB-Wetterdaten; \textbf{JavaEE})
...
{\begin{itemize}
	...
	\item Erweiterung des Prototypen für Energiemanagement (\textbf{Java}, OSGi/Equinox)
	\item Betreuung von Studentischen Arbeiten
	\begin{itemize}
		\item Implementierung eines Event-basierten Simulationskerns (\textbf{Java})
	\end{itemize}
\end{itemize}}
...
{\begin{itemize}
	...
	\item Implementierung eines Prototypen für Energiemanagement (\textbf{Java}, OSGi/Equinox)
\end{itemize}}
...
{\begin{itemize}
	...
	\begin{itemize}
		...
		\item Implementierung einer Bibliothek zur Verarbeitung von ATML (\textbf{Java})
		\item Prototyperstellung für Ressourcenplanung und Testprogrammsynthese (\textbf{Java})
...
\cvline{Betr.-Syst.}{Windows, Unix (Linux, Solaris), Mac OS X; Embedded: Linux, FreeRTOS, picoOS}
