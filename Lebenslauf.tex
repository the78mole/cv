...
\cventry{03/17--heute}{Senior Software Consultant}{Angestellter}{Nürnberg}{IPN Solutions GmbH \& Co. KG}%
{\begin{itemize}
	\item Geschäftsleitung in den Bereichen Finanzierung, Marketing, Vertrieb, IKT, Akquise, Teamleitung
	\item Startup- \& Produktplanung, sowie Entwicklung eines Baby-Wearables für einen Kunden
	\item Digitale Transformation bei Schwesterfirma (Coaching, Consulting, Umsetzung)
	\item Projekt Digitale Transformation, Digitialisierung der Geschäftsprozesse (camunda, AngularJS)
	\item Übernahme der Geschäftsleitung von Vorgänger
\end{itemize}}

\cventry{11/14--02/17}{Senior Software Consultant}{Angestellter}{Nürnberg}{IPN Solutions GmbH \& Co. KG}%
{\begin{itemize}
	\item Projektleitung \& Softwarearchitektur, digitale Karte (C++, Embedded Linux, ASIL-B)
	\item Aufbau einer CI-Toolchain für Embedded System der digitalen Karte (Jenkins, JUnit)
	\item Einführung agiler Entwicklungs-Methoden für Embedded Projekt der digitalen Karte (SCRUM)
	\item Aufbau Cert-Serivce für EOL Device-Zertifikate (JavaEE, Bouncycastle, REST)
\end{itemize}}

\cventry{11/11--03/14}{Geschäftsführer}{Gesellschafter}{Erlangen}{beECO GmbH}%
{\begin{itemize}
	\item Hardwareentwicklung, IT-Infrastruktur, Marketing \& Vertrieb
\end{itemize}}
...
\cvline{Betr.-Syst.}{Windows, Unix (Linux, Solaris), Mac OS X; Embedded: Linux, picoOS}
\cvline{Dienste}{MySQL, Apache, Samba, Subversion, Maven, Jenkins, OpenVPN, Tomcat, u.a.}
\cvline{Office}{MS Office (inkl. VBA), iWork, OpenOffice/LibreOffice, LaTeX, Scribus}
...
%%%%%%%%%%%%%%%%%%
%\section{Patente}
%\cvline{in Prüfung}{Bestimung des Durchflusses eines Mediums durch ein Gefäß}
...
%%%%%%%%%%%%%%%%%%
\section{Interessen}
\cvline{}{Schaltungsentwurf, Freie Software, handwerkliche Tätigkeiten, Heimwerken}
\cvline{}{Fahrrad fahren, Beach-Volleyball, Billard, Bergwandern, Kochen, Lesen}
