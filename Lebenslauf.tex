...
\photo[140pt]{Bewerbungsbild_zugeschnitten}                         % '64pt' is the height the picture must be resized to and 'picture' is the name of the picture file; optional, remove the line if not wanted
...
\cventry{05/18--jetzt}{Teamleiter \& Entwickler}{Angestellter}{Fürth}{Dommel GmbH}%
{\begin{itemize}
	\item Aufbau des Standorts Fürth
	\item Leitung des Entwicklungsteams
	\item Planung \& Systementwurf von Embedded-Projekten
	\item Hardware- \& Softwareentwicklung von eingebetteten Systemen (STM32, AVR, Holtek, ESP32)
	\item PC-Anwendungsentwicklung (Firmware-Updater, Service-Tools; JavaSE, QT, electron/JS)
...
{\begin{itemize}
	\item Geschäftsleitung in den Bereichen Finanzen, Marketing, Vertrieb, IKT, Akquise, Teamleitung
...
{\begin{itemize}
	...
	\item Einführung agiler Entwicklungs-Methoden für Projekt \glqq digitale Straßenkarte\grqq \,(SCRUMBAN)
	\item Entwicklung eines CA-Frontends für Verwaltung und Erstellung von Zertifikaten (Bootstrap)
	\item Aufbau eines Self-Service für Device-Zertifikate (WebUI, JavaEE, Bouncycastle, REST)
	\item Anpassung eines Linux-Kernel an Custom-Embedded-Board (Gigabit-Ethernet-Treiber)
\end{itemize}}
...
{\begin{itemize}
	...
	\begin{itemize}
		\item Konfiguration einer Zentraleinheit (Embedded Industrial PC, Linux, Java/Equinox/Karaf)
		\item Erfassung von KWK-Kraftwerksdaten (Embedded uC Knoten , Ethernet, PoE)
		\item Prognose der Folgetage auf Basis von Wetterdaten (Künstliche Neuronale Netze; Encog)
		\item VPN zur Fernwartung und Verbindung mit Backend (OpenVPN)
		\item Server-Infrastruktur (Vorverarbeitung und Archivierung der Daten; JavaEE, Bash)
		\item Over-The-Air-Update aller Komponenten (TFTP, BOOTP,...)
	\end{itemize}
\end{itemize}}

\cventry{03/12--02/14}{Wissenschaftlicher Mitarbeiter}{Stipendiat}{Erlangen}{Lehrstuhl für Sensorik LSE, Friedrich-Alexander-Universität Erlangen-Nürnberg}%
{\begin{itemize}
	\item Förderprogramm FLÜGGE-Bayern (Existenzgründung, Projekt beECO)
	\item Betreuung von Studentischen Arbeiten
\end{itemize}}

\cventry{03/11--02/12}{Selbstständiger}{Stipendiat}{Erlangen}{Lehrstuhl für Sensorik LSE, Friedrich-Alexander-Universität Erlangen-Nürnberg}%
{\begin{itemize}
	\item EXIST-Gründerstipendium (Projekt ambience, später beECO)
\end{itemize}}

\cventry{12/07--12/10}{Wissenschaftlicher Mitarbeiter}{Doktorand}{Erlangen}{Lehrstuhl für Zuverlässige Schaltungen und Systeme LZS (ehem. LRS), Friedrich-Alexander-Universität Erlangen-Nürnberg}%
{\begin{itemize}
	...
	\begin{itemize}
		...
		\item Modellierung und Simulation des Prüflings, der Schnittstellen und des Testsystems
		\item Ressourcenplanung und Testsynthese
	\end{itemize}
	\item Lehre
	\begin{itemize}
...
\cventry{06/07--10/07}{Wissenschaftliche Hilfskraft}{Student}{Erlangen}{Lehrstuhl für Rechnergestützten Schaltungsentwurf LRS, Friedrich-Alexander-Universität Erlangen-Nürnberg}{%
\begin{itemize}
...
\cventry{06/04--05/07}{Wissenschaftliche Hilfskraft}{Student}{Erlangen}{Fraunhofer IIS, Bildsensorik}{Entwicklung von Hard- und Software, VHDL%
\begin{itemize}
...
\cventry{07/03--10/11}{Selbstständiger}{Freelancer}{Erlangen}{Einzelunternehmeń}{%
Konzeptionierung und Entwicklung von Hard- und Software%
\begin{itemize}
	\item FPGA-Entwicklung in VHDL und zugehöriger Hardware
...
%	\item Erweiterung des Shopsystems osCommerce zur Anbindung von Großhändlern
%	\item Erweiterung des Shopsystems um einfache Warenwirtschaft
%	\item Automatisierte, stündliche Preis- und Verfügbarkeits-Aktualisierung (>25.000 Artikel)
%\end{itemize}
%}
...
%\section{Freiwillige \& Ehrenamtliche Tätigkeiten}
%\cventry{11/03--12/11}{Administrator}{Studentenwohnheim Ratiborer Straße}{Erlangen}{}{Benutzerverwaltung, Support, Linux Server- und Netzwerkbetreuung}
...
\cvline{Betr.-Syst.}{Windows, Unix (Linux, Solaris), Mac OS X; Embedded: Linux, picoOS, FreeRTOS}
...
\cvline{Office}{MS Office (inkl. VBA), OpenOffice/LibreOffice, LaTeX, Scribus}
\cvline{SW-Entw.}{Java (Eclipse PDE, EMF,...), C, C++, PHP, Bash, LabView, u.a.}
\cvline{Elektrotechnik}{VHDL (Xilinx ISE, ModelSim, Lattice ispLEVER), SystemC (AMS), Eagle, Target!3001, LTspice, Pspice, u.a.}
...
%%%%%%%%%%%%%%%%%%
\section{Zertifikate \& Fortbildungen}
\cvline{SERVIEW}{Seminar SCRUM-Master}
\cvline{Grundig Akademie}{Europäischer Wirtschaftsführerschein EBC*L, Stufe A}
...
%%%%%%%%%%%%%%%%%%
\section{Interessen}
\cvline{}{Agile Arbeitsweisen, Schaltungsentwurf, Clean-Code-Development, Freie Software}
\cvline{}{3D-Druck, E-Mobility, Smart-Home, handwerkliche Tätigkeiten/Heimwerken, Fahrrad fahren}
\cvline{}{Billard, Bergwandern, Kochen, Lesen}
