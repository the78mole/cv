...
{\begin{itemize}
	...
	\begin{itemize}
		...
		\item Prognose der Folgetage auf Basis von Wetterdaten (Künstliche Neuronale Netze)
		\item VPN zur Fernwartung und Verbindung mit Backend (OpenVPN)
		\item Aufbau der zentralen Server-Infrastruktur (Vorverarbeitung und Archivierung der Daten)
		\item Over-The-Air-Update aller Komponenten
	\end{itemize}
\end{itemize}}
...
\cvline {Zertifikate}{Scrum-Master (Prüfung noch ausstehend)}
