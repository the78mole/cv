...
\address{Drausnickstraße 23}{91052 Erlangen}    % optional, remove the line if not wanted
...
\photo[140pt]{../Bewerbungsbilder/Bewerbungsbild_zugeschnitten}                         % '64pt' is the height the picture must be resized to and 'picture' is the name of the picture file; optional, remove the line if not wanted
