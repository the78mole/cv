...
{\begin{itemize}
	\item Projektleitung \& Softwarearchitektur, \glqq digitale Straßenkarte\grqq (C++, Embedded Linux, ASIL-B)
	\item Aufbau einer CI-Toolchain für Embedded System \glqq digitale Straßenkarte\grqq" (Jenkins, JUnit)
	\item Einführung agiler Entwicklungs-Methoden für Embedded Projekt \glqq digitale Karte\grqq (SCRUM)
	\item Entwicklung eines CA-Frontends für Verwaltung und Erstellung von Zertifikaten (Bootstrap)
	\item Aufbau eines Cert-Serivce für EOL Device-Zertifikate (JavaEE, Bouncycastle, REST)
\end{itemize}}
